...
const FAQ_ITEMS: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "제품의 크기·움직임 구조·포장 형태(OPP/벌크)·조립 방식(점착/끼우기)에 따라 단가가 달라집니다. 참고로 페이퍼토이는 1,000부 기준 개당 약 2,500~4,000원대에서 형성되며, 견적 문의 페이지에 수량·옵션을 남겨주시면 영업일 1~2일 내 담당자가 정확한 맞춤 견적을 회신드립니다.",
  },
  {
    category: "견적·수량",
    question: "디자인을 보유하고 있지 않아도 의뢰 가능한가요?",
    answer:
      "네, 가능합니다. PE Studio는 BI/CI 편집 디자인 서비스도 제공하므로, 컨셉만 있어도 기획·설계·디자인까지 원스톱으로 진행 가능합니다. KAIST 출신 개발자와 함께 캐릭터 및 구조를 처음부터 함께 설계해 드립니다.",
  },
  ...
  // 제품·기술
  {
    ...
    answer:
      "PE Studio는 자기 구조 설계 특허 11종을 기반으로 ①도형·내각 원리, ②무게중심·중력, ③탄성력 등을 활용해 평면이 입체로 변하거나 누워있던 물체가 스스로 일어나는 구조를 설계합니다.",
  },
  {
    category: "제품·기술",

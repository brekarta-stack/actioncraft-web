...
const FAQ_ITEMS: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "제품의 크기·움직임 구조·포장 형태(OPP/벌크)·조립 방식(점착/끼우기)에 따라 단가가 달라집니다. 자동 견적 페이지에서 옵션을 선택하면 추정 단가를 즉시 확인할 수 있고, 영업일 1~2일 내 담당자가 정확한 견적을 회신드립니다.",
  },
  {
    category: "견적·수량",
    question: "디자인을 보유하고 있지 않아도 의뢰 가능한가요?",
    answer:
      "네, 가능합니다. CES는 BI/CI 편집 디자인 서비스도 제공하므로, 컨셉만 있어도 기획·설계·디자인까지 원스톱으로 진행 가능합니다. KAIST 출신 개발자와 함께 캐릭터 및 구조를 처음부터 함께 설계해 드립니다.",
  },
  ...
  // 제품·기술
  {
    ...
    answer:
      "CES는 자기 구조 설계 특허 11종을 기반으로 ①도형·내각 원리, ②무게중심·중력, ③탄성력 등을 활용해 평면이 입체로 변하거나 누워있던 물체가 스스로 일어나는 구조를 설계합니다.",
  },
  {
    category: "제품·기술",
  ...
  // 협업·기타
  {
    ...
    answer:
      "국내 생산 후 해외 발송이 가능하며, 별도 운송비가 발생합니다. CES2024 등 글로벌 전시를 통해 해외 협업 경험도 보유하고 있습니다.",
  },
  {
    category: "협업·기타",
    question: "교육 강의·워크숍 운영도 가능한가요?",
    answer:
      "네, 페이퍼토이 만들기 워크숍, STEAM 교육 강의, PePaKuRa Designer 공식 교육 등을 운영하고 있습니다. 기업·학교·기관 단위 출강 가능합니다.",
  },
];

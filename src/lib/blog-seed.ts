...
export const SEED_POSTS: Post[] = [
  /* ─────────────── 글 1: 지자체 관광 담당자 ─────────────── */
  {
    ...
    tag: "사례 연구",
    emoji: "",
    coverImage: "https://image.pollinations.ai/prompt/colorful%20korean%20local%20government%20festival%20paper%20craft%20mascot%20characters%20outdoor%20community%20event%20families?width=1200&height=630&nologo=true&model=flux&seed=1001",
    published: true,
    createdAt: NOW,
    updatedAt: NOW,
...
축제·행사 일정이 있다면 [무료 견적 페이지](/quote)에서 1분 만에 견적을 받아보세요.`,
  ...
  /* ─────────────── 글 2: 교육 담당자 ─────────────── */
  {
    ...
    tag: "교육",
    emoji: "",
    coverImage: "https://image.pollinations.ai/prompt/elementary%20school%20children%20classroom%20paper%20engineering%20steam%20origami%20craft%20workshop%20teacher%20students%20learning?width=1200&height=630&nologo=true&model=flux&seed=1002",
    published: true,
    createdAt: NOW,
    updatedAt: NOW,
...
학기 시작 전 도입을 검토하신다면 [자동 견적 페이지](/quote)에서 1분 만에 견적을 확인해 보세요.`,
  ...
  /* ─────────────── 글 3: AI 시대 인지 효과 ─────────────── */
  {
    ...
    tag: "교육",
    emoji: "",
    coverImage: "https://image.pollinations.ai/prompt/hands%20carefully%20folding%20colorful%20paper%20origami%20mindful%20craft%20workshop%20creativity%20analog%20experience?width=1200&height=630&nologo=true&model=flux&seed=1003",
    published: true,
    createdAt: NOW,
    updatedAt: NOW,
...
학교, 학원, 가정 모두에서 활용 가능한 페이퍼 엔지니어링 교구가 궁금하시다면 [PE Studio 제품 소개](/products)를 확인해 보세요.`,
  ...
  /* ─────────────── 글 4: 기업 굿즈 담당자 ─────────────── */
  {
    ...
    tag: "사례 연구",
    emoji: "",
    coverImage: "https://image.pollinations.ai/prompt/creative%20corporate%20gift%20paper%20toy%20office%20desk%20employee%20promotional%20unboxing%20branding%20business?width=1200&height=630&nologo=true&model=flux&seed=1004",
    published: true,
    createdAt: NOW,
    updatedAt: NOW,
...
자세한 단가와 제작 가능 형태는 [무료 견적 페이지](/quote)에서 1분이면 확인할 수 있습니다.`,
  ...
  /* ─────────────── 글 5: 외주 체크리스트 ─────────────── */
  {
    ...
    tag: "제작 과정",
    emoji: "",
    coverImage: "https://image.pollinations.ai/prompt/paper%20craft%20design%20studio%20professional%20quality%20inspection%20production%20process%20workshop?width=1200&height=630&nologo=true&model=flux&seed=1005",
    published: true,
    createdAt: NOW,
    updatedAt: NOW,

...
말은 거창하지만 출발은 단순하다. 종이 한 장이 어떻게 하면 스스로 설 수 있을까. 그 질문을 13년째 붙들고 있다. 종이로 만들고 싶은 것이 있다면 [무료 견적](/quote)에서 이야기를 들려주면 된다.`,
  },
  {
...
여기에 캠을 더하면 위아래·회전·흔들림이 한꺼번에 일어난다. 손잡이 한 번에 캐릭터가 고개를 젓고 팔을 드는, 작은 기계 같은 움직임이 만들어진다. 흔히 오토마타라 부른다.

마지막으로 자석을 쓰는 자기력까지 더하면, 종이로 만들 수 있는 움직임의 폭은 생각보다 넓다. 어떤 움직임이 어울릴지는 캐릭터와 쓰임에 따라 다르다. 만들고 싶은 장면이 있다면 [무료 견적](/quote)에서 함께 골라도 좋다.`,
  },
  {
...
결국 팝업북은 평면과 입체 사이를 오가는 장치다. 닫으면 한 장이고, 열면 무대가 된다. 그 전환의 순간을 설계하는 일이 우리가 하는 일이다. 만들고 싶은 장면이 있다면 [무료 견적](/quote)에서 이야기해도 좋다.`,
  },
  {
...
물론 종이만큼 정교한 움직임을 담기는 어렵다. 대신 크고 단단하게, 손쉽게 세우는 쪽에 강하다. 만들 자리가 정해져 있다면 어떤 재료가 맞을지 [무료 견적](/quote)에서 함께 가늠해 봐도 좋다.`,
  },
  {
...
여기에 코팅의 유무, 친환경 인증지 여부까지 더해지면 선택지는 더 늘어난다. 손님 눈에는 보이지 않는 결정이지만, 결과물의 수명은 대개 이 보이지 않는 자리에서 갈린다. 어떤 종이가 맞을지는 만들 물건에 따라 다르다. 정해 두신 게 있다면 [무료 견적](/quote)에서 함께 골라도 좋다.`,
  },
  {
...
그래서 우리가 만드는 교구의 절반은 전개도에 있다. 아이가 한 장의 평면을 접어 입체를 세우는 동안, 교과서가 말로만 설명하던 것을 손끝으로 먼저 안다. 전개도를 활용한 교구가 궁금하다면 [제품 소개](/products)를 봐도 좋다.`,
  },

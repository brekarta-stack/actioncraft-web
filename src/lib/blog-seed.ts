...
이듬해 전자신문은 우리를 '움직이는 페이퍼 토이'를 교육과 비즈니스로 끌고 온 곳이라 소개했다([전자신문, 2017](https://m.etnews.com/20171219000432)). 그 뒤로 일은 방과후 수업과 자유학기제 교실로, 서울역사박물관 같은 박물관 체험과 DDP 디자인놀이터로, 교보문고와 롯데마트 매대로 조금씩 넓어졌다.

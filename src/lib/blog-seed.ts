...
export const SEED_POSTS: Post[] = [
  /* ─────────────── 글 1: 지자체 관광 담당자 ─────────────── */
  {
    ...
    tag: "사례 연구",
    emoji: "",
    coverImage: "https://fastly.picsum.photos/id/412/1200/630.jpg?hmac=QGpS-0pbH_8jxypdiM56lt8I6Jb2-w8rL4UKyaRryyg",
    published: true,
    createdAt: NOW,
    updatedAt: NOW,
...
축제·행사 일정이 있다면 [무료 견적 페이지](/quote)에서 1분 만에 견적을 받아보세요.`,
  ...
  /* ─────────────── 글 2: 교육 담당자 ─────────────── */
  {
    ...
    tag: "교육",
    emoji: "",
    coverImage: "https://fastly.picsum.photos/id/486/1200/630.jpg?hmac=PrOuTNJqp9__yr4a7byydyvawf5aqXVxYDBnt5I9fL8",
    published: true,
    createdAt: NOW,
    updatedAt: NOW,
...
학기 시작 전 도입을 검토하신다면 [자동 견적 페이지](/quote)에서 1분 만에 견적을 확인해 보세요.`,
  ...
  /* ─────────────── 글 3: AI 시대 인지 효과 ─────────────── */
  {
    ...
    tag: "교육",
    emoji: "",
    coverImage: "https://fastly.picsum.photos/id/363/1200/630.jpg?hmac=4RdvfZ7pzxSLV2TntwtJtHn5VszS-gQTJHRT96lVWD8",
    published: true,
    createdAt: NOW,
    updatedAt: NOW,
...
학교, 학원, 가정 모두에서 활용 가능한 페이퍼 엔지니어링 교구가 궁금하시다면 [PE Studio 제품 소개](/products)를 확인해 보세요.`,
  ...
  /* ─────────────── 글 4: 기업 굿즈 담당자 ─────────────── */
  {
    ...
    tag: "사례 연구",
    emoji: "",
    coverImage: "https://fastly.picsum.photos/id/17/1200/630.jpg?hmac=FIfYs2qcAsyhpN09N0s3VCFj7ZR85hwTLCVbPKxh5M4",
    published: true,
    createdAt: NOW,
    updatedAt: NOW,
...
자세한 단가와 제작 가능 형태는 [무료 견적 페이지](/quote)에서 1분이면 확인할 수 있습니다.`,
  ...
  /* ─────────────── 글 5: 외주 체크리스트 ─────────────── */
  {
    ...
    tag: "제작 과정",
    emoji: "",
    coverImage: "https://fastly.picsum.photos/id/533/1200/630.jpg?hmac=q-_meRQJl-S4ZMIWPoAtkd4iChpb134zVsQCN3m7L-Q",
    published: true,
    createdAt: NOW,
    updatedAt: NOW,

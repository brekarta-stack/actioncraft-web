...
회사 이름도 거기서 나왔다. 움직임을 뜻하는 '액션(action)'과 만들기를 뜻하는 '크래프트(craft)'를 붙여 액션크래프트라 지었다. 2017년 전자신문은 우리를 '움직이는 페이퍼 토이'를 교육과 비즈니스로 끌고 온 곳이라 소개했다([전자신문, 2017](https://m.etnews.com/20171219000432)). 그 무렵부터 일은 방과후 수업과 자유학기제 교실로, 박물관 체험과 DDP 디자인놀이터로, 교보문고와 롯데마트 매대로 조금씩 넓어졌다.

돌아보면 전문성이라는 건 한 번에 생기지 않았다. 종이접기 도안 한 장, 쓰러진 시제품 하나, 납품한 교구 한 세트가 쌓여 만들어졌다. 특허 열한 가지도 그 축적의 결과지 출발점이 아니었다.

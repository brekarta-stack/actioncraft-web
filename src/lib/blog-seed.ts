...
먼저 만들어 보내드린다. 그게 우리가 일을 시작하는 방식이다.`,
  },
  {
    ...
    updatedAt: "2022-11-15T12:00:00.000Z",
...
여전히 우리는 작은 스튜디오다.`,
  ...
  /* ─────────────── 글 1: 지자체 관광 담당자 ─────────────── */
  {
    ...
    published: true,
    createdAt: "2022-09-15T12:00:00.000Z",
    updatedAt: "2022-09-15T12:00:00.000Z",
...
대단한 전략은 아니다. 다만 도시마다 똑같던 굿즈의 자리에, 시민이 한 번 더 만지는 물건을 놓아 보는 일이다.`,
  ...
  /* ─────────────── 글 2: 교육 담당자 ─────────────── */
  {
    ...
    updatedAt: "2022-07-15T12:00:00.000Z",
...
결과물을 만드는 일이 흔해질수록, 그 결과물을 어떻게 세울지 생각하는 힘이 차이를 만든다. 그리고 그 힘은 종이든 블록이든, 물성을 손으로 다뤄 본 사람에게서 자란다. 거창한 결론은 아니다. 다만 화면 밖에서 종이 한 장을 세워 보는 저녁이, 생각보다 오래 남는다는 이야기다.`,
  ...
  /* ─────────────── 글 4: 기업 굿즈 담당자 ─────────────── */
  {
    ...
    published: true,
    createdAt: "2022-03-15T12:00:00.000Z",
    updatedAt: "2022-03-15T12:00:00.000Z",
...
복잡해 보이지만 결국 한 가지다. 보이지 않는 조건을 처음에 꺼내 놓는 곳이 끝까지 덜 어긋난다.`,
  ...
  /* ─────────────── 2021 추가분 (시작기 회고·기술 노트 6편) ─────────────── */
  {
    ...
    emoji: "",
    published: true,
    createdAt: "2021-11-15T12:00:00.000Z",
    updatedAt: "2021-11-15T12:00:00.000Z",
...
소량일 때는 칼로, 많을 때는 도무송으로. 그 경계를 가늠하는 것도 오래 일하며 익힌 감각이다.`,
  },
  {
    ...
    title: "접기에도 공리가 있다 — 종이접기 속 수학",
    excerpt:
      "접는 행위 자체가 하나의 수학이다. 후지타 공리와 하가의 정리처럼, 종이접기에 숨은 기하 이야기.",
    tag: "교육",
    emoji: "",
    published: true,
    createdAt: "2021-09-15T12:00:00.000Z",
    updatedAt: "2021-09-15T12:00:00.000Z",
...
접기는 종이를 다루는 기술이기 전에, 평면과 각도를 다루는 가장 오래된 방법 중 하나다. 그 사실이 나는 여전히 신기하다.`,
  },
  {
    ...
    title: "종이에 색이 입혀지는 자리 — 인쇄와 발색 이야기",
    excerpt:
      "같은 빨강도 종이가 다르면 다른 빨강이 된다. 화면의 색이 종이 위에 앉는 과정에 대해.",
    tag: "소재",
    emoji: "",
    published: true,
    createdAt: "2021-07-15T12:00:00.000Z",
    updatedAt: "2021-07-15T12:00:00.000Z",
...
캐릭터의 인상은 형태만큼이나 색에서 온다. 그 색이 앉을 자리를 종이가 정한다는 것을, 일하면서 자주 떠올린다.`,
  },
  {
    ...
    updatedAt: "2021-05-15T12:00:00.000Z",
...
화려한 한 철을 위해 오래 남을 폐기물을 만들지 않아도 된다는 것. 전시장에 종이를 세우는 일의 조용한 장점이다.`,
  },
  {
    ...
    updatedAt: "2021-03-15T12:00:00.000Z",
    content: `"열 개만 만들 수 있나요?"라는 문의를 종종 받는다. 마음 같아선 그러고 싶지만, 대개는 어렵다고 답한다. 미안한 마음에 그 이유를 정리해 둔다.
...
결국 견적은 '얼마예요'가 아니라 '몇 개를, 어떻게'에서 시작한다. 그 질문을 먼저 나누는 편이 서로에게 정직하다.`,
  },
  {
    ...
    title: "오리고 접어 세우는 글자 — 종이로 만든 입체 레터링",
    excerpt:
    ...
    updatedAt: "2021-01-15T12:00:00.000Z",
...
종이로 글자를 세우는 일은, 결국 '읽는 것'을 '가지는 것'으로 바꾸는 작업이다. 우리가 캐릭터에서 해 온 일을, 글자에서 다시 하는 셈이다.`,
  ...
  /* ─────────────── 글 33: 학생용 도면 도구 ─────────────── */
  {
    ...
    title: "원하는 걸 찾아, 만들 수 있는 도면까지 — 학생의 손에 맞춘다는 것",
    excerpt:

...
export const SITE_DESCRIPTION =
  "Paper Engineering Studio(PE Studio)는 자기 구조 설계 특허 11종을 보유한 국내 유일의 페이퍼 엔지니어링 스튜디오입니다. 움직이는 페이퍼 크래프트·액션 페이퍼·팝업북·폼보드 크래프트를 주문 제작합니다. 2013년 창업, 현대백화점·KAIST 등 650건 이상 납품 실적.";
...
export const PAGE_META = {
  home: {
    ...
    description:
      "Paper Engineering Studio — 자기 구조 설계 특허 11종을 보유한 국내 유일의 페이퍼 엔지니어링 스튜디오. 페이퍼 크래프트·액션 페이퍼·팝업북·폼보드 크래프트를 주문 제작합니다. 2013년 창업, 현대백화점·KAIST 등 650건 이상 납품.",
  },
  about: {
  ...
  quote: {
    title: "1분 견적 문의 — 페이퍼 엔지니어링 제작 비용",
    description:
      "수량·옵션·납기만 입력하면 1분이면 끝. 영업일 1~2일 내 담당자가 맞춤 견적을 회신드립니다. 페이퍼토이·팝업북·액션 페이퍼·폼보드 크래프트 제작.",
  },
  faq: {
